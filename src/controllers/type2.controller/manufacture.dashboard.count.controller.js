...
const getInvitationDashboardCounts = async (req, res) => {
  ...
  const data =
    await manufactureDashboardCountsService.getInvitationDashboardCounts(email);
...
const getCategoryDashboardCounts = async (req, res) => {
  ...
  const data = await manufactureDashboardCountsService.getCategoryDashboardCounts(
    manufacturerEmail
  );
...
const getDashboardOverview = async (req, res) => {
  ...
  const data =
    await manufactureDashboardCountsService.getDashboardOverview({
      email,
      role,
    });
