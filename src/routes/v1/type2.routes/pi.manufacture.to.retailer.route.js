...
router
  ...
  .get(
    auth('manufacture', 'retailer'),
    m2rPerformaInvoiceController.getAllInvoices
  );
...
router
  ...
  .get(
     auth('manufacture', 'retailer'),
    m2rPerformaInvoiceController.getInvoiceById
  )
  .put(
    auth('manufacture'),
    m2rPerformaInvoiceController.updateInvoice
  )
  .patch(
    auth('manufacture'),
    m2rPerformaInvoiceController.updateDeliveryItems
  )
  .delete(
    auth('manufacture'),
    m2rPerformaInvoiceController.deleteInvoice
  );
