...
router.route('/').post(manufacturerVendorController.createVendor).get(manufacturerVendorController.queryVendors);
...
router.route('/perment/:id').delete(manufacturerVendorController.deleteVendorPerment);
