...
router.route('/').post(manufactureWarehouseController.createWarehouse).get(manufactureWarehouseController.queryWarehouses);
...
router.route('/perment/:id').delete(manufactureWarehouseController.deleteWarehousePerment);
