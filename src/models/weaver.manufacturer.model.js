...
const weaverManufactureSchema = mongoose.Schema(
  {
    logo: {
      type: String,
    },
...
weaverManufactureSchema.plugin(toJSON);
weaverManufactureSchema.plugin(paginate);
 ...
 */
weaverManufactureSchema.statics.isEmailTaken = async function (email, excludeUserId) {
 ...
 * @returns {Promise<boolean>}
 */
weaverManufactureSchema.methods.isPasswordMatch = async function (password) {
  const user = this;
  return bcrypt.compare(password, user.password);
};

weaverManufactureSchema.pre('save', async function (next) {
  const user = this;
...
weaverManufactureSchema.methods.getVisibleProfile = function () {
...
/**
 * @typedef WeaverManufacture
 */
const WeaverManufacture = mongoose.model('WeaverManufacture', weaverManufactureSchema);

module.exports = WeaverManufacture;
