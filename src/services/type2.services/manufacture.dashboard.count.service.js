...
//         },
//         confirmed: {
//           $sum: { $cond: [{ $eq: ['$statusAll', 'm_order_confirmed'] }, 1, 0] },
//         },
//         partialDelivery: {
//           $sum: { $cond: [{ $eq: ['$statusAll', 'm_partial_delivery'] }, 1, 0] },
//         },
//         makeToOrder: {
//           $sum: { $cond: [{ $eq: ['$statusAll', 'make_to_order'] }, 1, 0] },
//         },
//         delivered: {
//           $sum: { $cond: [{ $eq: ['$statusAll', 'delivered'] }, 1, 0] },
//         },
...
// const getAllDashboardCounts = async ({ email, role }) => {
//   const [poCounts, productCounts, invoiceCounts, returnCounts, creditNoteCounts, inventoryCounts] = await Promise.all([
//     getManufacturerPORetailerCounts({ email, role }),
//     getProductDashboardCounts({ email, role }),
//     getPerformaInvoiceDashboardCounts({ email, role }),
//     getReturnDashboardCounts({ email, role }),
